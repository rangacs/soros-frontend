...
const DashboardManagement = () => {
    ...
    const getData = React.useCallback(() => {
        DashboardMakerService.getAllDashboardMaker()
            .then((res) => {
                if (res && res.data) {
                    const data = res.data;
                    setRows(data);
    ...
    const deleteRecord = async (id) => {
        DashboardMakerService.deleteDashboardMaker(id)
            .then((res) => {
                if (res.message) {
    ...
    return (
        <Grid item xs={12} sm={6} lg={12} spacing={gridSpacing}>
            <MainCard style={{ padding: 0 }} title="Dashboard Maker" darkTitle=" ">
                    ...
                    <CardContent>
                        <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                            ...
                            <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                                <Tooltip title="Create Layout">
                                    <Link to="/settings/dashboard-maker-layout">
                                        <Fab
                                            color="primary"
                                            size="small"
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="center" sx={{ pr: 3 }}>
                                                    <Link to={`/settings/dashboard-maker-layout/${row.layout_id}`}>
