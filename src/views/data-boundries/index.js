...
const DataBoundriesManagement = () => {
    ...
    const getData = React.useCallback(() => {
        DataBoundriesService.getAllDataBoundries()
            .then((res) => {
                if (res && res.data) {
                    const data = res.data;
                    setRows(data);
    ...
    const deleteRecord = (id) => {
        DataBoundriesService.deleteDataBoundries(id)
            .then((res) => {
                if (res.message) {
    ...
    return (
        <Grid item xs={12} sm={6} lg={12} spacing={gridSpacing}>
            <MainCard style={{ padding: 0 }} title="Data Boundries Management" darkTitle=" ">
                    ...
                    <CardContent>
                        <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                            ...
                            <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                                <Tooltip title="Add Data Boundries">
                                    <Fab
                                        color="primary"
                                        size="small"
                                        onClick={() => {
                                            ...
                                            >
                                                ...
                                                <TableCell align="center" sx={{ pr: 3 }}>
                                                    <IconButton component={Button}>
                                                        <IconEdit onClick={() => editHandler(row.ac_id)} />
                                                    </IconButton>
                                                    <IconButton
                                                        aria-label="delete"
                                                        onClick={() => {
                                                            setConfirmOpen(true);
                                                            setDeleteId(row.ac_id);
                                                        }}
                                                    >
                                                        <DeleteIcon />
                                                    </IconButton>
                                                    <div>
                                                        ...
                                                        >
                                                            <DialogTitle id="alert-dialog-title">Delete Data Boundries</DialogTitle>
                                                            <DialogContent>
                                                                <DialogContentText id="alert-dialog-description">
                                                                    Do you want to delete the Data Boundries ?
                                                                </DialogContentText>
                                                            </DialogContent>
                                                            <DialogActions>
...
export default DataBoundriesManagement;
