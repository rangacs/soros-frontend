...
const CalibrationManagement = () => {
    ...
    return (
        <Grid item xs={12} sm={6} lg={12} spacing={gridSpacing}>
            <MainCard style={{ padding: 0 }} title="Calibration Management" darkTitle=" ">
                                            ...
                                            >
                                                ...
                                                <TableCell align="center" sx={{ pr: 3 }}>
                                                    ...
                                                    <div>
                                                        ...
                                                        >
                                                            <DialogTitle id="alert-dialog-title">Delete Calibration</DialogTitle>
                                                            <DialogContent>
                                                                <DialogContentText id="alert-dialog-description">
                                                                    Do you want to delete the Calibration ?
                                                                </DialogContentText>
                                                            </DialogContent>
                                                            <DialogActions>
