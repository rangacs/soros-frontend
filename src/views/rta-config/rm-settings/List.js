...
import RmSettingsAdd from './Form';
            ...
            rmSettingsService
                ...
                .then((res) => {
                    if (res.data) {
                        ...
                        setRows(newRows);
                        Formik.setFieldValue('search', newString);
                    }
                })
                .catch((err) => {
                    // toast.error('search not done');
                    console.log(err.response);
                });
        } else {
            Formik.handlechange();
        ...
        <>
            <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                ...
                <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                    <Tooltip title="Add R M Settings">
                        <Fab
                            color="primary"
                            size="small"
                            onClick={() => {
                    ...
                    {open && <RmSettingsAdd id={id} open={open} handleCloseDialog={() => setOpen(!open)} getData={getData} />}
                </Grid>
            </Grid>
