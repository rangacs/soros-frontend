...
const headCells = [
    ...
    },
    {
        ...
        disablePadding: false,
        label: 'DB_ID_string',
        columnName: 'DB_ID_string'
    },
    {
        id: 'rtaConfigTable',
        numeric: false,
        disablePadding: false,
        label: 'rtaConfigTable',
        columnName: 'rtaConfigTable'
    },
    {
        id: 'DBwriteActive',
        numeric: false,
    ...
    },
    {
        ...
        numeric: false,
        disablePadding: false,
        label: 'write_frequency',
        columnName: 'write_frequency'
    },
    {
        id: 'DB_counter',
        numeric: false,
        disablePadding: false,
        label: 'DB_counter',
        columnName: 'DB_counter'
    },
    {
        id: 'timeConversionMassflowWeight',
        numeric: false,
        disablePadding: false,
        label: 'timeConversionMassflowWeight',
        columnName: 'timeConversionMassflowWeight'
    }
];
                                    ...
                                    >
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            <IconButton component={Button}>
                                                <IconEdit onClick={() => editHandler(row.rtaMasterID)} />
                                            </IconButton>
                                            <IconButton
                                                aria-label="delete"
                                                onClick={() => {
                                                    setConfirmOpen(true);
                                                    setDeleteId(row.rtaMasterID);
                                                }}
                                            >
                                                <DeleteIcon />
                                            </IconButton>
                                                ...
                                                >
                                                    ...
                                                    <DialogContent>
                                                        <DialogContentText id="alert-dialog-description">
                                                            Do you want to delete the Config ?
                                                        </DialogContentText>
                                                    </DialogContent>
                                                    <DialogActions>
...
export default RtaPhysicalConfig;
