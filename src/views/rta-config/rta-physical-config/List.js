...
const headCells = [
    ...
    },
    {
        ...
        columnName: 'goodDataSecondsWeight_physicalCfg'
    },
    {
        ...
        columnName: 'massflowWeight_physicalCfg'
    },
    {
        ...
        columnName: 'analysis_timespan'
    },
    {
        id: 'averaging_subinterval_secs',
        numeric: false,
        disablePadding: false,
        label: 'Averaging Subinterval',
        columnName: 'averaging_subinterval_secs'
    },
    {
        id: 'detectorID',
        numeric: false,
                                    ...
                                    >
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            <IconButton component={Button}>
                                                <IconEdit onClick={() => editHandler(row.rta_ID_physical)} />
                                            </IconButton>
                                            <IconButton
                                                aria-label="delete"
                                                onClick={() => {
                                                    setConfirmOpen(true);
                                                    setDeleteId(row.rta_ID_physical);
                                                }}
                                            >
                                                <DeleteIcon />
                                            </IconButton>
