                            ...
                            <Grid container alignItems="center">
                                <Grid item xs={6}>
                                    <Grid container alignItems="center">
                                        {/* <Grid item>
                                            {timeValue ? (
                                                <Typography className={classes.cardHeading}>40%</Typography>
                                            ) : (
                                                <Typography className={classes.cardHeading}>36%</Typography>
                                            )}
                                        </Grid> */}
                                        <Grid item>
                                        ...
                                        <Grid item xs={12}>
                                            <Typography className={classes.subHeading}>Women Ratio</Typography>
                                        </Grid>
                                    </Grid>
                                </Grid>
                                {/* <Grid item xs={6}>
