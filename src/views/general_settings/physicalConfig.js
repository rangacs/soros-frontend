...
import MonitorDropDownAdd from './MonitorDropDownAdd';
...
const MonitorDropdownManagement = () => {
    ...
    const getData = React.useCallback(() => {
        MonitorColumnsDropdownService.getAllMonitorColumnsDropdown()
            .then((res) => {
                if (res && res.data) {
                    const data = res.data;
                    setRows(data);
    ...
    const deleteRecord = async (id) => {
        MonitorColumnsDropdownService.deleteMonitorColumnsDropdown(id)
            .then((res) => {
                if (res.message) {
        ...
        <>
            <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                ...
                <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                    ...
                    {open && <MonitorDropDownAdd id={id} open={open} handleCloseDialog={() => setOpen(!open)} getData={getData} />}
                </Grid>
            </Grid>
                                    ...
                                    >
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <DialogTitle id="alert-dialog-title">Delete Dropdown</DialogTitle>
                                                    <DialogContent>
                                                        <DialogContentText id="alert-dialog-description">
                                                            Do you want to delete the Dropdown option ?
                                                        </DialogContentText>
                                                    </DialogContent>
                                                    <DialogActions>
...
export default MonitorDropdownManagement;
