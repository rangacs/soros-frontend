...
import { LOGGED_USER } from 'store/actions';
            ...
            <Formik
                ...
                onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                    try {
                        ...
                        dispatchLogin({ type: LOGGED_USER, payload: { loggedUser: data.user } });
                        login(data);
                        navigate('/');
