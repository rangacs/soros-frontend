...
function EnhancedTableHead(props) {
    ...
    const [startDate, setStartDate] = React.useState('2022-09-28');
    const [startTime, setStartTime] = React.useState('10:00');
    const dispatch = useDispatch();
    const [intervalStartDate, setIntervalStartDate] = React.useState('2022-09-28');
    const [intervalStartTime, setIntervalStartTime] = React.useState('10:00');

    const [intervalEndDate, setIntervalEndDate] = React.useState('2022-09-28');
